    ...
    <div class="main" id="main">
        <div class="search_box">
            ...
            <div class="search_input_box">
                ...
                <label class="search_label">‘한식대첩’을 검색해보세요</label>
            </div>
        ...
        <div class="categorys">
            ...
            <div class="convenience cate_box">
                ...
                <div class="subcate_box">
                    ...
                    <div class="sub_one_box">
                        <div class="sub_one_circle">
                            <img class="parkinglot_icon icon_circle" src="/svg/parkinglot_icon.svg" />
                        </div>
                    ...
                    <div class="sub_one_box">
                        <div class="sub_one_circle">
                            <img class="playroom_icon icon_circle" src="/svg/playroom_icon.svg" />
                        </div>
                    ...
                    <div class="sub_one_box">
                        <div class="sub_one_circle">
                            <img class="handicap_icon icon_circle" src="/svg/handicap_icon.svg" />
                        </div>
                        <div class="text">
                            장애인<br>편의시설
                        </div>
                    ...
                    <div class="sub_one_box">
                        <div class="sub_one_circle">
                            <img class="waitingArea_icon icon_circle" src="/svg/waitingroom_icon.svg" />
                        </div>
                ...
                <div class="user_review">
                    ...
                    <div class="user_review_box">
                        <div class="user_review_text">
                            까마귀도 좋아하는 맛있는 파스타 근데 이제 푸실리를 곁들인 저희 할머니도 무척 맛있게 드셨어요.
                            최고의 오리엔탈 퓨전 파스타입니다. 추천해요~
                        </div>
