...
public class StoreGridAllDTO {
    ...
    public StoreGridAllDTO(int sg_idx, int store_idx, int store_floor, int sg_col, int sg_row, String sts_idx,
			String sts_location, int sts_type_idx, int sts_num, int table_num) {
		super();
		this.sg_idx = sg_idx;
    ...
    public StoreGridAllDTO(int sg_idx, int store_idx, int store_floor, int sg_col, int sg_row, String sts_idx,
			String sts_location, int sts_type_idx, int sts_num, int table_num, List<StoreGridDetailDTO> gridData) {
		super();
		this.sg_idx = sg_idx;
		this.store_idx = store_idx;
		this.store_floor = store_floor;
