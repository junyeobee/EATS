...
public class TimelineDTO {
	...
	public TimelineDTO(int reserve_idx, int user_idx, int store_idx, Date reserve_date, String reserve_time,
			...
			String user_nickname, String store_name, String store_addr, int follow_idx, int following_idx,
			int total_reviews, int follower_count, int following_count, String profile_image) {
		super();
